...
/*Uma Class de ferramentas Java que faz com que seja aprensentada caixas de dialogo no sistema*/
...
public class Aula11_Criando_Entrada_Dados {
	...
	public static void main(String[] args) {
		...
		/*Como recebemos os Dados como Strings teremos de fazer a conversão para 
		 * tipos numericos para se fazer operaçoes matematicas.*/
